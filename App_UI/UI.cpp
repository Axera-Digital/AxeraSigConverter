...
void Overlay::Loop()
{
    ...
    RegisterClassEx(&wc);
    hwnd = CreateWindow(wc.lpszClassName, "ASC", WS_POPUP, 0, 0, 5, 5, NULL, NULL, wc.hInstance, NULL);
...
void Render::UI()
{
    ...
    if (ImGui::Begin("ASC", 0, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoTitleBar))
    {
